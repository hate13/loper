		...
		<div id="respond">
		    ...
		    <?php else : ?>
				...
				<div id="author_info">
					...
					<div class="writerinfodiv">
						<input type="email" name="email" id="email" value="<?php echo $comment_author_email; ?>" tabindex="2" /><label for="email" ><?php _e('邮箱');?> <?php if ($req) _e('(用于显<a href="http://www.gravatar.com">Gravata</a>头像，必填)'); ?></label>
					</div>	
