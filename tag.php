...
<div id="content">
	...
	<h1 class="tags"><?php printf( __('Tag Archives: %s' ), '<span class="categorytext"> ' . single_tag_title( '', false ) .'</span>' ); ?> </h1>
	<span class="catedescription"><?php echo tag_description(); ?></span>
