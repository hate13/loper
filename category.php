...
<div id="content">
	...
	<h1 class="category"><?php printf( __( 'Category Archives: %s' ), '<span class="categorytext"> ' . single_cat_title( '', false ) . '</span>' ); ?> </h1>
	<span class="catedescription"><?php echo category_description(); ?></span>
